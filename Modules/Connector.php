...
/**
 * ----------------------------------------------------------------
 * ############## YOU ARE FREE TO RE-USE THIS MODULE ##############
 * ##############      IN YOUR OWN PROJECTS.         ##############
 * ----------------------------------------------------------------
 * ##############    I AM NOT RESPONSIBLE FOR ANY    ##############
 * ##############     SECURITY ISSUES THAT MIGHT     ##############
 * ##############       ENDANGER YOUR PROJECT        ##############
 * ##############  THE MODULE IMPLEMENTS THE COMMON  ##############
 * ############## AND MOST WIDELY USED SANITIZATION  ##############
 * ##############             METHODS                ##############
 * ----------------------------------------------------------------
 * ##############   MIND YOUR SECURITY ON YOUR OWN   ##############
 * ----------------------------------------------------------------
 * ----------------------------------------------------------------
...
class Connector
{
  ...
  function __construct(
    ...
    if (!is_null($hostname)) $this->host = $hostname;
    if (!is_null($username)) $this->user = $username;
    if (!is_null($password)) $this->pass = $password;
    if (!is_null($database)) $this->name = $database;

    $resource = mysqli_connect($this->host, $this->user, $this->pass, $this->name);

    if ($resource) $this->connection = $resource;
